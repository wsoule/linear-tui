...
export const KEY_COMMANDS = [
  ...
  { key: "viewStatusFilter", label: "Filter by status" },
  ...
  { key: "issueEdit", label: "Edit title/description" },
  { key: "issueCycle", label: "Set cycle" },
  { key: "issuePriority", label: "Set priority" },
